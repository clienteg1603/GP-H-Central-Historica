# -*- coding: utf-8 -*-
"""
GP-H Central Histórica v0.44.0
...
class App(tk.Tk):
    ...
    def _decision_build_meta(self, body, snapshot):
        ...
        ttk.Label(wf_head,text="v0.44 • cérebro v0.1 congelado",style="CardMuted.TLabel").pack(side="right")
        ttk.Label(
            card,
